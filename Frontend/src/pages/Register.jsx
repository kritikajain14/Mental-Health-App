  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-400">
            Start your mental health support journey today
          </p>
        </div>
        ...
        {/* Benefits */}
        <div className="bg-linear-to-br from-gray-900 to-gray-800 rounded-3xl p-6 border border-gray-700">
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li className="flex items-center space-x-3">
              ...
              <span>Emotion tracking and insights</span>
            </li>
            <li className="flex items-center space-x-3">
              <div className="w-5 h-5 bg-pink-500/20 rounded-full flex items-center justify-center">
                <span className="text-pink-400 text-xs">✓</span>
              </div>
              <span>Safe and private conversations</span>
            </li>
          </ul>
        </div>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-pink-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-pink-600/5 rounded-full blur-3xl"></div>
      </div>
    </div>
  )
}
